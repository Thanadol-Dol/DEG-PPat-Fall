    ...
    private void OnMouseDown()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (playerObject != null)
            {
                ...
                {
                    WhilePuzzleManager whilePuzzleManager = GameObject.Find("WhilePuzzleManager").GetComponent<WhilePuzzleManager>();
                    whilePuzzleManager.CollectColor(gameObject.name);
                    Debug.Log("Color collected: " + gameObject.name);
                }
                else
                {
